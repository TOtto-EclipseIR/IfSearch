...
const qint64 MillisecondDelta::second_ms = 1000;
const qint64 MillisecondDelta::minute_ms = 60 * second_ms;
const qint64 MillisecondDelta::hour_ms = 60 * minute_ms;
const qint64 MillisecondDelta::day_ms = 24 * hour_ms;
const qint64 MillisecondDelta::week_ms = 7 * day_ms;
...
qint64 MillisecondDelta::setToMinutes(qreal mins)
{
    clear();
