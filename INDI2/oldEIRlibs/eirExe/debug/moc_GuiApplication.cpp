...
**
** Created: Tue Dec 24 16:47:13 2013
...
static const char qt_meta_stringdata_GuiApplication[] = {
    "GuiApplication\0"
};

const QMetaObject GuiApplication::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_GuiApplication,
      qt_meta_data_GuiApplication, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GuiApplication::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GuiApplication))
        return static_cast<void*>(const_cast< GuiApplication*>(this));
    if (!strcmp(_clname, "ExeSupport"))
        return static_cast< ExeSupport*>(const_cast< GuiApplication*>(this));
