...
#define LOGADD(sev, fmt, ...)   LOG(add(sev, __MODULE__, __FILE__, __LINE__, Q_FUNC_INFO, fmt, ##__VA_ARGS__))
#define LOGADDVL(sev, fmt, qvl) LOG(add(sev, __MODULE__, __FILE__, __LINE__, Q_FUNC_INFO, fmt, qvl))
...
#define TODO(fmt, ...)      LOGADD(Severity::ToDo, "TODO: " fmt, ##__VA_ARGS__)
...
#define FUNCTION(...)       LogFunction log_function_instance(false, __FILE__, __LINE__, Q_FUNC_INFO, ##__VA_ARGS__)
#define FNSLOT(...)         LogFunction log_function_instance(true,  __FILE__, __LINE__, Q_FUNC_INFO, ##__VA_ARGS__)
