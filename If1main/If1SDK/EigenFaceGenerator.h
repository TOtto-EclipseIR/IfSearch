...
namespace INDI
{
    ...
    public:
        ...
        DDT::Return setImage(const QString & fileName);
        DDT::Return setImage(DDT::ImageCache * cache, const QString & imageId);
        DDT::Return setImage(const QImage & image,
                             const DDT::ImageInfo & info=DDT::ImageInfo(),
        ...
        DDT::Return generateTemplate(int minConsistencyOverride=0);
        ...
        { return DDT::QQRect(head) * (1.0 / HeadScale); }
        Eyes expectedEyes(void) const
        { return ExpectedEyes * (1.0 / HeadScale); }
        QRect leftEyeRoi(void) const
        { return DDT::QQRect(LeftEyeRoi) * (1.0 / HeadScale); }
        QRect rightEyeRoi(void) const
        { return DDT::QQRect(RightEyeRoi) * (1.0 / HeadScale); }
        ...
        { return Consistency; }
        DDT::ImageInfo getInfo(void)
        { DDT::ImageInfo ii; fSet.calculate(); ii.addFace(fSet); return ii; }
    ...
    private:
        ...
        DDT::Return adjustEyes(void);
        DDT::Return findHead(void);
        DDT::Return findEyes(void);
        DDT::Return generateNormalized(void);
