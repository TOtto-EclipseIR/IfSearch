...
namespace INDI
{
	...
	public:
		...
		static DDT::Return readXmlFile(const QString & fileName);
		static DDT::Return writeXmlFile(const QString & fileName);
		static int find(const QString & v, const QString & sv=QString());
		static int insert(const QString & v, const QString & sv=QString());

	protected:
		int Key;
		static DDT::DualMap<int, QPair<QString, QString> >	valueMap;
		static bool dirty;
