                  ...
                  const int line)
{
    ...
    add(InfoItem(DDT::InfoSeverity::Debug, file, line, "Expected %1 (%2)==(%3) %4",
...
/*
void Info::applicationVersion(VersionInfo * ver)
{
    QFileInfo fi(qApp->arguments().first());
    add(DDT::InfoItem(DDT::InfoSeverity::Progress, QObject::tr("---Running %1", "application version status"),
        fi.absoluteFilePath()));
    if (QDir::current() != fi.dir())
        add(DDT::InfoItem(DDT::InfoSeverity::Info, QObject::tr("   from %1"), QDir::current().absolutePath()));
    add(DDT::InfoItem(DDT::InfoSeverity::Info, QObject::tr("   Description: %1", "application version status"),
        ver->description()));
    add(DDT::InfoItem(DDT::InfoSeverity::Info, QObject::tr("   Version: %1 (%2)", "application version status"),
        ver->toString(), ver->dateStamp()));
    add(DDT::InfoItem(DDT::InfoSeverity::Info, QObject::tr("   Copyright: %1", "application version status"),
        ver->copyright()));
}

void Info::libraryVersion(VersionInfo * ver)
{
    add(DDT::InfoItem(DDT::InfoSeverity::Progress, QObject::tr("---Loaded %1", "library version status"),
        ver->name()));
    add(DDT::InfoItem(DDT::InfoSeverity::Info, QObject::tr("   Description: %1", "library version status"),
        ver->description()));
    add(DDT::InfoItem(DDT::InfoSeverity::Info, QObject::tr("   Version: %1 (%2)", "library version status"),
        ver->toString(), ver->dateStamp()));
    add(DDT::InfoItem(DDT::InfoSeverity::Info, QObject::tr("   Copyright: %1", "library version status"),
        ver->copyright()));
}
*/
