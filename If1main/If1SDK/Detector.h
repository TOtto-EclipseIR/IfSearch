...
namespace INDI
{
    ...
    */
    ...
    public:
        ...
        void setCache(DDT::ImageCache * Cache) { cache = Cache; }
        void clear(void);
    ...
    public:
        static DDT::Return initialize(QFile * xmlFile);
        ...
        bool isStrange(DDT::QQRect rect);
    ...
    private:
        ...
        virtual DDT::QQRect doAdjust(DDT::QQRect r) = 0;
    ...
    public:
        ...
        virtual DDT::QQRect doAdjust(DDT::QQRect r);
    ...
    public:
        ...
        bool process(QList<DetectorResult> * resultList=0, bool returnAll=false);
        virtual int scaleScore(qreal raw) { return HaarDetector::scaleScore(raw); }
        virtual DDT::QQRect doAdjust(DDT::QQRect r) { return r; }
