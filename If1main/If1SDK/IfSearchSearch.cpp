...
void IfSearch::searchOrVerify(void)
{
    ...
    if (searchPersonKey)
    {
        ...
        EigenFaceSearchResultList resList
                = eigenMatcher->search(INDI::EigenFaceSearchSettings::Verify,
                                       searchTemplate,
                                       &searchSettings,
                                       faceKeys);
    ...
    else
    {
        ...
        EigenFaceSearchResultList resList
                = eigenMatcher->search(INDI::EigenFaceSearchSettings::FormalSearch,
                                   searchTemplate,
                                   &searchSettings);
...
void IfSearch::searchFinish(void)
{
    ...
    {
        INFO("[SEARCH] %1 writes pending", fwpSearch->sizePending());
